...
- [Evaluating the current and future capacity for natural climate solutions in Canada's oceans.](www.BlueCarbonCanada.ca) Research funded by the Natural Science and Engineering Research Council (NSERC) and Fisheries and Oceans Canada (DFO). PI: Dr. Julia K. Baum (UVic); Co-PIs: Drs. Mary O'Connor (UBC), Sara Knox (McGill), & Philippe Archembault (U. Laval). *Role: Mitacs Accelerate Postdoctoral Fellow.*

- [Developing an integrated monitoring and assessment framework for evaluating ecosystem service outcomes from seagrass restoration in the Gulf of Mexico](https://www.lester-lab.com/seagrass) Research funded by the National Academy of Science, Engineering, and Mathematics (NASEM) Gulf Research Program. PI: Dr. Sarah E. Lester (FSU); Co-PI: Dr. Andrew Rassweiler (FSU). *Role: PhD student; Co-wrote & co-developed project.* 
